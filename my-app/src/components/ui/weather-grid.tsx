...
const WeatherGrid = (props: WeatherGridProps) => {
    return (
        <div className="w-64 cursor-pointer border border-gray-300 rounded-lg shadow-md bg-white transition-all duration-300 hover:shadow-lg">
        <div className="flex flex-col justify-center items-center text-center p-6">
          <div className="text-lg font-semibold flex flex-col text-gray-800 mb-2">
          ...
          <p className="text-gray-600 mb-2">{props.weatherTypeName}</p>
          <div className="text-4xl font-bold text-gray-800 mb-4">{props.tempC}<sup>o</sup>C</div>
          <div className="flex justify-center w-full">
            <div className="flex items-center text-gray-600 mr-6">
              <svg
                ...
                width="20"
                height="20"
                className="mr-2 fill-current text-blue-500"
              >
            ...
            <div className="flex items-center text-gray-600">
              ...
              >
                ...
                <path d="M3.5,9a1,1,0,1,0-1-1A1,1,0,0,0,3.5,9Zm4,0h7a3,3,0,0,0,0-6,3.06,3.06,0,0,0-1.5.4,1,1,0,0,0-.37,1.37A1,1,0,0,0,14,5.13,1.09,1.09,0,0,1,14.5,5a1,1,0,0,1,0,2h-7a1,1,0,0,0,0,2Zm-4,4h7a1,1,0,0,0,0-2h-7a1,1,0,0,0,0,2Zm17-4a1,1,0,1,0-1-1A1,1,0,0,0,20.5,9Zm-2,2h-4a1,1,0,0,0,0,2h4a1,1,0,0,1,0,2,1,1,0,0,0,0,2,3,3,0,0,0,0-6Zm-6,4h-4a1,1,0,0,0,0,2h4a1,1,0,0,1,0,2,1.09,1.09,0,0,1-.5-.13,1,1,0,1,0-1,1.73,3.06,3.06,0,0,0,1.5.4,3,3,0,0,0,0-6Zm-8,0h-1a1,1,0,0,0,0,2h1a1,1,0,0,0,0-2Z"></path>
              </svg>
              {props.wind} km/h
            </div>
          </div>
